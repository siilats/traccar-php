...
class DefaultApi
{
    ...
    /**
     * Operation sessionUpdatedevicePost
     *
    ...
    /**
     * Operation sessionUpdatedevicePostWithHttpInfo
     *
     * Get data on user Bike and Geofence
     *
     * @param  string $adminemail (required)
    ...
    /**
     * Operation sessionUpdatedevicePostAsync
     *
     * Get data on user Bike and Geofence
     *
     * @param  string $adminemail (required)
    ...
    /**
     * Operation sessionUpdatedevicePostAsyncWithHttpInfo
     *
     * Get data on user Bike and Geofence
     *
     * @param  string $adminemail (required)
    ...
    /**
     * Create request for operation 'sessionUpdatedevicePost'
     *
     * @param  string $adminemail (required)
     * @param  string $adminpassword (required)
     * @param  int $commandid (required)
    ...
    protected function sessionUpdatedevicePostRequest($adminemail, $adminpassword, $commandid, $body)
    {
        ...
        if ($adminemail === null || (is_array($adminemail) && count($adminemail) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $adminemail when calling sessionUpdatedevicePost'
            );
        }
        // verify the required parameter 'adminpassword' is set
        if ($adminpassword === null || (is_array($adminpassword) && count($adminpassword) === 0)) {
        ...
        if ($body === null || (is_array($body) && count($body) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $body when calling sessionUpdatedevicePost'
            );
        }

        $resourcePath = '/session/updatedevice';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
